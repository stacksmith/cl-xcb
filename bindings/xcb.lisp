...
(defconstant GC-FOREGROUND 4)
(defconstant GC-GRAPHICS-EXPOSURES  65536)

(defxcb ("xcb_create_gc" create-gc)
  (cid            :uint32)
  (drawable       :uint32)
  (value-mask     :uint32)
  (value-list     :pointer)) 
...
(defconstant COORD-MODE-PREVIOUS 0)
(defxcb ("xcb_poly_line" poly-line)
  (coordinate-mode :uint8)
  (drawable        :uint32)
  (gc              :uint32)
  (points-len      :uint32)
  (points          :pointer))
